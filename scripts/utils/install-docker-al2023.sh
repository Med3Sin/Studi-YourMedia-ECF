...
# Script d'installation manuelle de Docker pour Amazon Linux 2023
# À exécuter sur l'instance EC2 avec sudo
...
log "Démarrage de l'installation manuelle de Docker pour Amazon Linux 2023"
