...
variable "ecs_task_cpu" {
  description = "CPU alloué aux conteneurs Docker (non utilisé directement, mais requis pour la compatibilité)."
  type        = number
}

variable "ecs_task_memory" {
  description = "Mémoire allouée aux conteneurs Docker (non utilisé directement, mais requis pour la compatibilité)."
  type        = number
}
